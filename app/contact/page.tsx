    ...
    <div style={{ minHeight: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ padding: "50px", display: "flex", flexDirection: "column", alignItems: "center", gap: "30px" }}>
        <div style={{
          ...
          boxShadow: "0 0 25px #00ffff, 0 0 50px #1e3a8a", border: "5px solid #fff"
        }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px", width: "100%", maxWidth: "500px" }}>
          ...
          <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Your Email" required
            style={{ padding: "12px", borderRadius: "12px", border: "1px solid #ccc", fontSize: "14px", width: "100%" }} />
          <textarea value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Your Message" required rows={5}
            style={{ padding: "12px", borderRadius: "12px", border: "1px solid #ccc", fontSize: "14px", width: "100%", resize: "none" }} />

          <button onClick={handleSubmit} style={{
            padding: "12px", borderRadius: "12px", border: "none", background: "linear-gradient(90deg, black, #1e3a8a)",
            color: "white", fontWeight: "bold", cursor: "pointer", fontSize: "16px", boxShadow: "0 0 10px #00ffff", transition: "0.3s"
          }}
